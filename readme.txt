...
1. Settings screen: connect the store with a Cachicamo App API token.
2. Product list showing the Cachicamo App sync status column.
3. Order detail showing the Cachicamo App invoicing status.
